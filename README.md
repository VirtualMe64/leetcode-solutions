...
- [0038_count-and-say](solutions/0038_count-and-say.py) - used caching and lists to beat 99%
- [0856_consecutive-numbers-sum](solutions/0856_consecutive-numbers-sum.py) - beat ~95% using a math based approach
- [3657_check-if-grid-can-be-cut-into-sections](solutions/3657_check-if-grid-can-be-cut-into-sections.py) - beat 99% with sorting technique
- [3699_number-of-zig-zag-arrays-i](solutions/3962_number-of-zigzag-arrays-i.py) - hard daily problem where i ended up finding a pretty clean solution
